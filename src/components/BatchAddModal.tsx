        ...
        <div className="px-4 sm:px-5 py-3.5 border-b border-zinc-200/80 flex items-center justify-between shrink-0 bg-white">
          <div className="flex items-center space-x-2">
            ...
            <div>
              ...
              <p className="text-[11px] text-zinc-500">Separe por linha ou por vírgula</p>
            </div>
          </div>
          ...
          <div className="p-4 sm:p-5 space-y-4">
            <div>
              <label className="block text-xs font-semibold text-zinc-700 mb-1.5">
                Lista de itens (por linha ou vírgula) <span className="text-red-500">*</span>
              </label>
              <textarea
                rows={6}
                required
                autoFocus
                placeholder={`leite, carne, 2 pães\nou\n2 Leite\n1 Arroz 5kg\nCafé`}
                value={batchText}
            ...
            <div className="bg-emerald-50/80 border border-emerald-200/80 rounded-xl p-3 text-xs text-emerald-900 leading-relaxed space-y-1">
              ...
              <p>
                Você pode digitar itens separados por vírgula (ex:{' '}
                <code className="bg-emerald-100 px-1 rounded font-bold text-emerald-950">leite, carne</code>) ou por linha. Se quiser, inclua a quantidade no início (ex:{' '}
                <code className="bg-emerald-100 px-1 rounded font-bold text-emerald-950">2 Leite, 3 Sabão</code>).
              </p>
            </div>
          </div>
